var App = function () {
	...
	var handleDashFlotCharts = function () {
        ...
        var chart6 = window.chart = $('#dash_pie_6').data('easyPieChart');
        //Pie 7
        ...
        var chart7 = window.chart = $('#dash_pie_7').data('easyPieChart');
        //Pie 8
        ...
        var chart8 = window.chart = $('#dash_pie_8').data('easyPieChart');
        //Pie 9
        ...
        var chart9 = window.chart = $('#dash_pie_9').data('easyPieChart');
		//Update the charts
		$('.js_update').on('click', function() {
			...
			chart3.update(Math.random()*100);
            chart4.update(Math.random()*100);
            chart5.update(Math.random()*100);
            chart6.update(Math.random()*100);
            chart7.update(Math.random()*100);
            chart8.update(Math.random()*100);
            chart9.update(Math.random()*100);
			chart_revenue();
		});
	}
	/*-----------------------------------------------------------------------------------*/
