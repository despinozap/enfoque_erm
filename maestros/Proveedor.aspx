<%@ Page Title="" Language="C#" MasterPageFile="~/MasperPage/skin.master" AutoEventWireup="true" CodeFile="Proveedor.aspx.cs" Inherits="maestros_Proveedor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<div class="col-sm-12">
			<div class="page-header">
				...
				<div class="clearfix"  style="margin: 20px">
					<h3 class="content-title pull-left padding-top-10"><i class="fa fa-users"></i> Proveedor</h3>
    ...
    <div class="row divInsertar" id="InsertUserDiv">
        <div class="col-md-12">
			...
			<div class="box border blue">
				<div class="box-title">
					<h4><i class="fa fa-user"></i>Proveedor Nuevo</h4>
				...
				<div class="box-body">
                    <div class="form-horizontal" role="form" action="#">
                        <div class="form-group">
						    ...
						    <div class="col-md-3">											 
							    <asp:TextBox type="text" ID="txtNewSap" class="form-control" runat="server" ReadOnly="false"></asp:TextBox>										 
						    </div>
						    <label class="col-md-2 control-label">
							    Rut
						    </label>
	...
	<div class="col-md-12">
		<div class="box border blue">
			<div class="box-title">
				<h4><i class="fa fa-user"></i>Editar Proveedor</h4>
				<div class="tools hidden-xs hidden">
					<a href="#box-config" data-toggle="modal" class="config">
						<i class="fa fa-cog"></i>
					</a>
			...
			<div class="box">
				...
				<div class="box-body">
					<div class="alert alert-block alert-danger fade in">
						...
						<h4><i class="fa fa-times"></i> Eliminar Proveedor!</h4>
    ...
    <!-- DATA TABLES -->
		<div class="col-md-12">            
			...
			<div class="box border blue">
				<div class="box-title">
					<h4><i class="fa fa-users"></i>Proveedores</h4>
					<div class="tools hidden-xs hidden">
						<a href="#box-config" data-toggle="modal" class="config">
							<i class="fa fa-cog"></i>
						</a>
...
<script type="text/javascript">
    ...
    function updateUser(e) {
        ...
        var razonsocial = $(e).parent().parent().children('td').eq(6).text();
        mail = $(e).attr("mail")
